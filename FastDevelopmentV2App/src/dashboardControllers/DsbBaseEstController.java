...
public class DsbBaseEstController extends DsbBaseController {
	...
	public void initCustomLayout(DsbBaseCrudView crudView,String layout) {
		...
		case "register":
			...
			registerView.getLbl1().getLabel().setText(v.getEstStatusLbl());
		...
		case "modify":
			...
			modifyView.getLbl1().getLabel().setText(v.getEstStatusLbl());
		...
		case "search":
			...
			searchView.getLbl1().getLabel().setText(v.getEstStatusLbl());
		...
		case "delete":
			...
			deleteView.getLbl1().getLabel().setText(v.getEstStatusLbl());
