...
public class DsbBaseCategController extends DsbBaseController {
	...
	public void initCustomLayout(DsbBaseCrudView crudView,String layout) {
		...
		case "register":
			...
			registerView.getLbl1().getLabel().setText(v.getCategCategoryLbl());
		...
		case "modify":
			...
			modifyView.getLbl1().getLabel().setText(v.getCategCategoryLbl());
		...
		case "search":
			...
			searchView.getLbl1().getLabel().setText(v.getCategCategoryLbl());
		...
		case "delete":
			...
			deleteView.getLbl1().getLabel().setText(v.getCategCategoryLbl());
