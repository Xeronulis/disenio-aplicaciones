...
public class DsbBasePayController extends DsbBaseController {
	...
	public void initCustomLayout(DsbBaseCrudView crudView,String layout) {
		...
		case "register":
			...
			registerView.getLbl1().getLabel().setText(v.getMetodoLbl());
		...
		case "modify":
			...
			modifyView.getLbl1().getLabel().setText(v.getMetodoLbl());
		...
		case "search":
			...
			searchView.getLbl1().getLabel().setText(v.getMetodoLbl());
			sCbx.addItem(v.getMetodoLbl());
		...
		case "delete":
			...
			deleteView.getLbl1().getLabel().setText(v.getMetodoLbl());
